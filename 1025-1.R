...
df = read.xlsx("C:/Users/AISW-509-183/Desktop/2024_2-2/강의/데이터분석실습/RScripts/map_datasets/국내지진목록.xlsx", sheet = 1, startRow = 4, colNames = FALSE)
head(df)
...
# shapefile 읽어오기
map = st_read("C:/Users/AISW-509-183/Desktop/2024_2-2/강의/데이터분석실습/RScripts/map_datasets/Z_NGII_N3A_G0010000.shp")
